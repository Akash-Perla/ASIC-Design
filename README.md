...
The table below provides the 32-bit binary encoding for a set of common RISC-V instructions:

| **Instruction**     | **Type** | **Opcode** | **Funct3** | **Funct7** | **rs1** | **rs2** | **rd** | **Immediate/Offset**  | **32-bit Pattern**                 | **Hexadecimal** |
|---------------------|----------|------------|------------|------------|---------|---------|--------|-----------------------|------------------------------------|-----------------|
| ADD r9, r10, r11    | R        | 0110011    | 000        | 0000000    | r10     | r11     | r9     | N/A                   | `0000000 01011 01010 000 01001 0110011` | `0x00B50233` |
| SUB r11, r9, r10    | R        | 0110011    | 000        | 0100000    | r9      | r10     | r11    | N/A                   | `0100000 01010 01001 000 01011 0110011` | `0x40A502B3` |
| AND r10, r9, r11    | R        | 0110011    | 111        | 0000000    | r9      | r11     | r10    | N/A                   | `0000000 01011 01001 111 01010 0110011` | `0x00B51733` |
| OR r8, r10, r5      | R        | 0110011    | 110        | 0000000    | r10     | r5      | r8     | N/A                   | `0000000 00101 01010 110 01000 0110011` | `0x00550A33` |
| XOR r8, r9, r4      | R        | 0110011    | 100        | 0000000    | r9      | r4      | r8     | N/A                   | `0000000 00100 01001 100 01000 0110011` | `0x00450833` |
| SLT r0, r1, r4      | R        | 0110011    | 010        | 0000000    | r1      | r4      | r0     | N/A                   | `0000000 00100 00001 010 00000 0110011` | `0x00402233` |
| SRL r6, r1, r1      | R        | 0110011    | 101        | 0000000    | r1      | r1      | r6     | N/A                   | `0000000 00001 00001 101 00110 0110011` | `0x00105333` |
| SLL r5, r1, r1      | R        | 0110011    | 001        | 0000000    | r1      | r1      | r5     | N/A                   | `0000000 00001 00001 001 00101 0110011` | `0x00105133` |
| ADDI r2, r2, 5      | I        | 0000011    | 010        | N/A        | r1      | N/A     | r3     | 0000000000000010      | `000000000010 00001 010 00011 0000011`  | `0x00210313` |
| SW r2, 4(r0)        | S        | 0100011    | 010        | N/A        | r0      | r2      | N/A    | 0000000000000100      | `0000000 00010 00000 010 00010 0100011` | `0x00202223` |
| BNE r0, r0, 20      | B        | 1100011    | 001        | N/A        | r0      | r0      | N/A    | 0000000000010100      | `0000000 00000 00000 001 00001 1100011` | `0x00000863` |
| BEQ r0, r0, 15      | B        | 1100011    | 000        | N/A        | r0      | r0      | N/A    | 0000000000001111      | `0000000 00000 00000 000 00000 1100011` | `0x00000063` |
...
![image](https://github.com/user-attachments/assets/e4884254-b57d-4afb-8376-fef818ec3f3d)
